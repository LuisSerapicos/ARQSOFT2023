...
import com.isep.acme.repositories.mongodb.ProductRepositoryMongoDB;
...
public class ProductBootstrapperMongoDB {
    ...
    CommandLineRunner commandLineRunner(){
        return args -> {
            ...
            if (pRepo.findBySku("t4f7e85f4g54").isEmpty()) {
                Product p13 = new Product("t4f7e85f4g54", " mac ", " pro m3 ");
                pRepo.saveProduct(p13);
            }
        };
    }
}
